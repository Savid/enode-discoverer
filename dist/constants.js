...
export const LOG_LEVEL = process.env.LOG_LEVEL || (dev ? 'debug' : 'warn');
export const PORT_ADMIN = process.env.PORT_ADMIN ?? '8081';
...
export const MAX_PEERS = !Number.isNaN(Number(process.env.MAX_PEERS))
    ...
    : undefined;
export const REMOTE_URL = process.env.REMOTE_URL ?? 'http://localhost:8080';
